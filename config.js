...
window.FIELD_SUGGESTIONS = {
    ...
    bodyLine: [
        { label: 'S字カーブ強調 ⏳', value: 'elegant S-curve silhouette emphasizing the delicate arch of the back and full hips' },
        { label: 'しなやかなひねり 🌪️', value: 'graceful torso twist creating dynamic and beautiful curved body lines' },
        { label: '縦ライン・脚長 📏', value: 'striking vertical body line emphasizing long, beautifully proportioned slender legs' }
    ],
    situation: [
