...
- facePlacement: 顔の向き(横顔や見返り等)の情報は完全に排除し、純粋に「正面を向いた場合のパーツの配置バランス」のみを逆算して記述せよ。
...
- additionalNotes (追記): モデルの人種(日本人、アジア系、白人系など)の印象を判別して必ず記載せよ。
【対象リスト】
${keyListString}`;
